...
describe('v3.FoldersClient', () => {
    ...
    describe('getFolder', () => {
        it('invokes getFolder without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetFolderRequest', ['name']);
    ...
    describe('updateFolder', () => {
        it('invokes updateFolder without error', async () => {
            ...
            request.folder ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateFolderRequest', ['folder', 'name']);
    ...
    describe('moveFolder', () => {
        it('invokes moveFolder without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('MoveFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteFolder', () => {
        it('invokes deleteFolder without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeleteFolder', () => {
        it('invokes undeleteFolder without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeleteFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
