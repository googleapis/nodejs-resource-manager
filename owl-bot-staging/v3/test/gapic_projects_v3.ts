...
describe('v3.ProjectsClient', () => {
    ...
    describe('getProject', () => {
        it('invokes getProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetProjectRequest', ['name']);
    ...
    describe('updateProject', () => {
        it('invokes updateProject without error', async () => {
            ...
            request.project ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateProjectRequest', ['project', 'name']);
    ...
    describe('moveProject', () => {
        it('invokes moveProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('MoveProjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteProject', () => {
        it('invokes deleteProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteProjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeleteProject', () => {
        it('invokes undeleteProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeleteProjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
