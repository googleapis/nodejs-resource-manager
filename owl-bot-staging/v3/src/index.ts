...
export {v3, FoldersClient, OrganizationsClient, ProjectsClient, TagBindingsClient, TagKeysClient, TagValuesClient};
export default {v3, FoldersClient, OrganizationsClient, ProjectsClient, TagBindingsClient, TagKeysClient, TagValuesClient};
