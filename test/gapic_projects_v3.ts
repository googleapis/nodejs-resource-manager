...
describe('v3.ProjectsClient', () => {
  ...
  describe('getProject', () => {
    ...
    it('invokes getProject without error using callback', async () => {
      ...
      client.innerApiCalls.getProject = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getProject(
  ...
  describe('createProject', () => {
    ...
    it('invokes createProject without error using callback', async () => {
      ...
      client.innerApiCalls.createProject = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateProject', () => {
    ...
    it('invokes updateProject without error using callback', async () => {
      ...
      client.innerApiCalls.updateProject = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('moveProject', () => {
    ...
    it('invokes moveProject without error using callback', async () => {
      ...
      client.innerApiCalls.moveProject = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.moveProject(
  ...
  describe('deleteProject', () => {
    ...
    it('invokes deleteProject without error using callback', async () => {
      ...
      client.innerApiCalls.deleteProject = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('undeleteProject', () => {
    ...
    it('invokes undeleteProject without error using callback', async () => {
      ...
      client.innerApiCalls.undeleteProject = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listProjects', () => {
    ...
    it('invokes listProjects without error using callback', async () => {
      ...
      client.innerApiCalls.listProjects = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listProjects(
    ...
    it('uses async iteration with listProjects without error', async () => {
      ...
      client.descriptors.page.listProjects.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listProjects
  ...
  describe('searchProjects', () => {
    ...
    it('invokes searchProjects without error using callback', async () => {
      ...
      client.innerApiCalls.searchProjects = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes searchProjectsStream without error', async () => {
      ...
      client.descriptors.page.searchProjects.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with searchProjects without error', async () => {
      ...
      client.descriptors.page.searchProjects.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      const responses: protos.google.cloud.resourcemanager.v3.IProject[] = [];
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.searchProjects
          .asyncIterate as SinonStub).getCall(0).args[1],
        request
      );
    });
