...
describe('v3.OrganizationsClient', () => {
  ...
  describe('getOrganization', () => {
    ...
    it('invokes getOrganization without error using callback', async () => {
      ...
      client.innerApiCalls.getOrganization = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('searchOrganizations', () => {
    ...
    it('invokes searchOrganizations without error using callback', async () => {
      ...
      client.innerApiCalls.searchOrganizations = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes searchOrganizationsStream without error', async () => {
      ...
      client.descriptors.page.searchOrganizations.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with searchOrganizations without error', async () => {
      ...
      client.descriptors.page.searchOrganizations.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.searchOrganizations
