...
describe('v3.TagBindingsClient', () => {
  ...
  describe('createTagBinding', () => {
    ...
    it('invokes createTagBinding without error using callback', async () => {
      ...
      client.innerApiCalls.createTagBinding = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteTagBinding', () => {
    ...
    it('invokes deleteTagBinding without error using callback', async () => {
      ...
      client.innerApiCalls.deleteTagBinding = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listTagBindings', () => {
    ...
    it('invokes listTagBindings without error using callback', async () => {
      ...
      client.innerApiCalls.listTagBindings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listTagBindingsStream without error', async () => {
      ...
      client.descriptors.page.listTagBindings.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with listTagBindings without error', async () => {
      ...
      client.descriptors.page.listTagBindings.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listTagBindings
