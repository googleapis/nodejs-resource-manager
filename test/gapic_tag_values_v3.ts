...
describe('v3.TagValuesClient', () => {
  ...
  describe('getTagValue', () => {
    ...
    it('invokes getTagValue without error using callback', async () => {
      ...
      client.innerApiCalls.getTagValue = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getTagValue(
  ...
  describe('createTagValue', () => {
    ...
    it('invokes createTagValue without error using callback', async () => {
      ...
      client.innerApiCalls.createTagValue = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateTagValue', () => {
    ...
    it('invokes updateTagValue without error using callback', async () => {
      ...
      client.innerApiCalls.updateTagValue = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteTagValue', () => {
    ...
    it('invokes deleteTagValue without error using callback', async () => {
      ...
      client.innerApiCalls.deleteTagValue = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listTagValues', () => {
    ...
    it('invokes listTagValues without error using callback', async () => {
      ...
      client.innerApiCalls.listTagValues = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listTagValuesStream without error', async () => {
      ...
      client.descriptors.page.listTagValues.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with listTagValues without error', async () => {
      ...
      client.descriptors.page.listTagValues.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listTagValues
