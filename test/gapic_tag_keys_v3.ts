...
describe('v3.TagKeysClient', () => {
  ...
  describe('getTagKey', () => {
    ...
    it('invokes getTagKey without error using callback', async () => {
      ...
      client.innerApiCalls.getTagKey = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getTagKey(
  ...
  describe('createTagKey', () => {
    ...
    it('invokes createTagKey without error using callback', async () => {
      ...
      client.innerApiCalls.createTagKey = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createTagKey(
  ...
  describe('updateTagKey', () => {
    ...
    it('invokes updateTagKey without error using callback', async () => {
      ...
      client.innerApiCalls.updateTagKey = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.updateTagKey(
  ...
  describe('deleteTagKey', () => {
    ...
    it('invokes deleteTagKey without error using callback', async () => {
      ...
      client.innerApiCalls.deleteTagKey = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deleteTagKey(
  ...
  describe('listTagKeys', () => {
    ...
    it('invokes listTagKeys without error using callback', async () => {
      ...
      client.innerApiCalls.listTagKeys = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listTagKeys(
