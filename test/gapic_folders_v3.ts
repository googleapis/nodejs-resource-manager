...
describe('v3.FoldersClient', () => {
  ...
  describe('getFolder', () => {
    ...
    it('invokes getFolder without error using callback', async () => {
      ...
      client.innerApiCalls.getFolder = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getFolder(
  ...
  describe('createFolder', () => {
    ...
    it('invokes createFolder without error using callback', async () => {
      ...
      client.innerApiCalls.createFolder = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createFolder(
  ...
  describe('updateFolder', () => {
    ...
    it('invokes updateFolder without error using callback', async () => {
      ...
      client.innerApiCalls.updateFolder = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.updateFolder(
  ...
  describe('moveFolder', () => {
    ...
    it('invokes moveFolder without error using callback', async () => {
      ...
      client.innerApiCalls.moveFolder = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.moveFolder(
  ...
  describe('deleteFolder', () => {
    ...
    it('invokes deleteFolder without error using callback', async () => {
      ...
      client.innerApiCalls.deleteFolder = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deleteFolder(
  ...
  describe('undeleteFolder', () => {
    ...
    it('invokes undeleteFolder without error using callback', async () => {
      ...
      client.innerApiCalls.undeleteFolder = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listFolders', () => {
    ...
    it('invokes listFolders without error using callback', async () => {
      ...
      client.innerApiCalls.listFolders = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listFolders(
  ...
  describe('searchFolders', () => {
    ...
    it('invokes searchFolders without error using callback', async () => {
      ...
      client.innerApiCalls.searchFolders = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes searchFoldersStream without error', async () => {
      ...
      client.descriptors.page.searchFolders.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with searchFolders without error', async () => {
      ...
      client.descriptors.page.searchFolders.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      const responses: protos.google.cloud.resourcemanager.v3.IFolder[] = [];
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.searchFolders
